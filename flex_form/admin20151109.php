...
$q = "SELECT * FROM employees WHERE (department_id='379' OR department_id='305' OR department_id='304' OR 

department_id='307' OR department_id='326' OR department_id='350' OR department_id='342' OR department_id='352' OR 

department_id='351' OR department_id='320' OR department_id='296' OR department_id='325' OR department_id='322')";
...
//$lnamearray = array();
        $i=0;
while ($myrow2 = mysqli_fetch_array($r, MYSQLI_NUM)) {
...
/*if ($thedept == 'ALL') {
	$query = "SELECT * FROM flex_form WHERE (date BETWEEN '$from' AND '$to') AND ((dept = 'CRITICAL CARE NURSING') OR 

(dept REGEXP '^PROGRESSIVE'))";
} */
if ($thedept == 'ALL') {
...
//radiology
	...
	$query = "SELECT * FROM flex_form WHERE (date BETWEEN '$from' AND '$to') AND (dept = 'Radiology Special 
...
<form name="form1" action="<?PHP echo $PHP_SELF ?>" method="post">
                <div align="center" class="style1"><strong>From</strong> 
                    <select name="fromMonth">
                                  ...
                                  <option value="<?PHP echo $_POST['fromMonth']; ?>" selected="selected"><?PHP echo 

$_POST['fromMonth']; ?></option>
                    ...
                    <select name="fromDay">
                      <option value='<?PHP echo $_POST['fromDay']; ?>'><?PHP echo $_POST['fromDay']; ?></option>
                    ...
                    <select name="fromYear">
                      <option value='<?PHP echo $_POST['fromYear']; ?>' selected="selected"><?PHP echo 

$_POST['fromYear']; ?></option>
                    ...
                    <strong> To</strong>
                    <select name="toMonth">
                                  <option value="<?PHP echo $_POST['toMonth']; ?>" selected="selected"><?PHP echo 

$_POST['toMonth']; ?></option>
								  <option value="01">January</option>
                                  <option value="02">February</option>
                                  <option value="03">March</option>
                                  <option value="04">April</option>
                    ...
                    <select name="toDay">
                      <option value='<?PHP echo $_POST['toDay']; ?>' selected="selected"><?PHP echo $_POST['toDay']; 
...
?></option>
                    ...
                    <select name="toYear">
                      <option value='<?PHP echo $_POST['toYear']; ?>' selected="selected"><?PHP echo $_POST['toYear']; 
...
value='<?PHP echo $_POST['requestor']; ?>'>
                    <br><br>
                    Dedpartment: <select name="thedept">
                      <option value='<?PHP echo $_POST['thedept']; ?>' selected="selected"><?PHP echo $_POST['thedept']; 
...
$result = mysqli_query($mysqli, $query);
			   ...
			   echo "<tr bgcolor=#003366><th width=200px><b><a href=\"?order=Department\"><font face=arial 

color=white size=1>EMPLOYEE ID</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>FIRST 

NAME</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>LAST 

NAME</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white 

size=1>DEPARTMENT</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white 

size=1>DATE</font></a></b></th>";
			   ...
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>WEEKDAY 

SHIFT</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>WEEKDAY SHIFT 

POINTS</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>WEEKEND 

SHIFT</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>WEEKEND SHIFT 

POINTS</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>PREMIUM 

SHIFT</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>PREMIUM SHIFT 

POINTS</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white 

size=1>FLOAT</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>FLOAT 

POINTS</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white 

size=1>RTO</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>RTO 

POINTS</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>SCHED 

CHANGE</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>SCHED CHANGE 

POINTS</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>SHORT 

NOTICE</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>SHORT NOTICE 

POINTS</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white size=1>OUTSIDE 

PARAMETERS</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white 

size=1>COMMENTS</font></a></b></th>";
			   echo "<th width=200px><b><a href=\"#\"><font face=arial color=white 

size=1>TOTAL</font></a></b></th></tr>";
        ...
        while($myrow = mysql_fetch_array($result))
             {//begin of loop
			   ...
			   $total_points = ($myrow['weekday_points'] + $myrow['weekend_points'] + 

$myrow['premium_points'] + $myrow['float_points'] + $myrow['rto_points'] + $myrow['sched_change_points'] + 

$myrow['short_notice_points'] + $myrow['outside_params']);
			   //$class = $myrow["class"];
			   echo "<tr bgcolor='$row_color' onmouseover=\"CngCol(this,'#fbf4a1');\"><td width=200px 

align=left valign=top><font face=arial size=2>";
               echo $myrow['employee'];
			 ...
			 <td width=200px align=left valign=top bgcolor=#003366><font face=arial size=2></td>
			 <td width=200px align=left valign=top bgcolor=#003366><font face=arial size=2></td>
			 <td width=200px align=left valign=top bgcolor='#f9d455'><font face=arial 

size=2>$grand_total</td></tr>";
			 echo "</table>";  		
			 
			 echo "<p><a href='excel.php?from=$from&to=$to&thename=$thename&thedept=$thedept'>Click here to 

export all records to excel.</a></p>";
...
?></option>
   ...
   <p>	 
   <p align="center"><strong><u>To export to Excel</u>:</strong> <br />Choose from the options above and click 'View this 

Range.' <br />Then <a href='excel.php'>click here</a> to export these records to excel.</p>
