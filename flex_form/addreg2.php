...
<form name="addreg" method="post" action="addreg3.php">
...
//$query = "SELECT *, R.TOT FROM classes C JOIN (SELECT class, COUNT(*) AS TOT FROM registrant GROUP BY class) R ON C.ID = R.class WHERE R.TOT <= C.max";
	  ...
	  echo "<table border=0 width=860px align=center>";
        ...
        while($myrow = mysql_fetch_array($result))
             {//begin of loop
			   ...
			   echo "<a href=\"addreg3.php?id=$myrow[id]&name=$name&dept=$dept\"><font color=#0000ff>Select</font></a>";
			   echo "</td></tr>";
			   $row_count++;
             }//end of loop
