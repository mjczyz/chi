...
$Fever_Achiness = str_replace("'","''",$Fever_Achiness);
...
$sql = "INSERT INTO illness_tbl (thedate, TimeOfCall, Name, NonMedical, NonMedicalOther, Diarrhea, NV, Headache, Respiratory, Injury, PregnancyRelated, UnknownSS, Fever_Achiness, MedicalOtherBox, MedicalOther, NameTakingMsg, Details, Department, FMLA) VALUES ('$Date', '$TimeOfCall', '$Name', '$NonMedical', '$NonMedicalOther', '$Diarrhea', '$NV', '$Headache', '$Respiratory', '$Injury', '$PregnancyRelated', '$UnknownSS', '$Fever_Achiness', '$MedicalOtherBox', '$MedicalOther', '$NameTakingMsg', '$Details', '$Department', '$FMLA')";
...
function ajaxFunction(){
	...
	var name = document.getElementById('fm-Name').value;
...
<form id="fm-form" method="post" action="<?php echo $PHP_SELF ?>" onSubmit="return formValidation(this)" language="JavaScript">
    ...
    <div class="fm-req">
      ...
      <!--<input name="Date" id="fm-Date" type="text" value=" echo date("m/d/Y"); ?>"/>-->
	  <? //$thedate = date("m/d/Y");

//if  ($thedate) {
   //$Day = substr(($thedate), 8);
   //$Month = substr(($thedate), 5, -3);
   ...
   ?>
	  <select name="Month" id="fm-Date">

                                  <option value="<? echo $Month ?>" selected="selected"><? echo $Month ?></option>
    ...
    <div class="fm-req">
      <label for="fm-Name">Name: (Last, First)</label>
      <input name="Name" id="fm-Name" type="text" onkeyup="ajaxFunction()" />
<!--<input type="text" id="txt1" onkeyup="ajaxFunction()">-->
<div id='ajaxDiv'></div>
    </div>
	<div class="fm-req">
	...
	<option value="7370-CARDIOLOGY(RMC)">7370-CARDIOLOGY(RMC)</option>
	...
	<option value="5050-SLEEP LAB(RMC)">5050-SLEEP LAB(RMC)</option>
	...
	<div id="mymenu2" class="hide">-->
	  ...
	  <label for="fm-Fever_Achiness">Fever/Achiness</label>
	  <input name="Fever_Achiness" type="checkbox" value="Fever_Achiness" id="fm-Fever_Achiness" /><br />
