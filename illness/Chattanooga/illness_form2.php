...
$sql = "INSERT INTO illness_tbl (Date, TimeOfCall, Name, NonMedical, NonMedicalOther, Diarrhea, NV, Headache, Respiratory, Injury, PregnancyRelated, UnknownSS, MedicalOtherBox, MedicalOther, NameTakingMsg, Details, Department) VALUES ('$Date', '$TimeOfCall', '$Name', '$NonMedical', '$NonMedicalOther', '$Diarrhea', '$NV', '$Headache', '$Respiratory', '$Injury', '$PregnancyRelated', '$UnknownSS', '$MedicalOtherBox', '$MedicalOther', '$NameTakingMsg', '$Details', '$Department')";
...
{
    if ((radio[0].checked)||(radio[1].checked)||(radio[2].checked)||(radio[3].checked)||(radio[4].checked)||(radio[5].checked))
        return true;
    else
        alert("You must fill in all required fields (*)")
}
