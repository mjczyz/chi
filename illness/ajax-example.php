...
$mysqli = new mysqli("localhost", "stez_user", "stez_1889", "absentee_db");
mysqli_connect("localhost", "stez_user", "stez_1889", "absentee_db");
...
$qry_result = mysqli_query($mysqli, $query);
